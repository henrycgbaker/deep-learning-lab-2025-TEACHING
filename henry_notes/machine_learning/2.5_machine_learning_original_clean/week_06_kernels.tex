...
\vspace*{0.3cm}
\begin{center}
	{\Large \bfseries ML Lecture Notes: Wk 6-I --- Kernels}
	\vspace{2mm}
...
\begin{itemize}
\item \textbf{Inducing Low-Rank Global Structure:}
    \begin{itemize}
...
\item \textbf{But also allow for local variation:}
        \begin{itemize}
...
\item \textbf{Or allow for Learning Different Features Demand Different Ideas of Similarity:}
        \begin{itemize}
