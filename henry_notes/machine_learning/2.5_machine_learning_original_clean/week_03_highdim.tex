...
\vspace*{0.3cm}
\begin{center}
	{\Large \bfseries ML Lecture Notes: Wk 3 --- High-dimensional methods and Regularisation}
	\vspace{2mm}
...
\begin{figure}[H]
    ...
    \label{fig:w03-regression-vs-classification}
\end{figure}
...
\begin{figure}[H]
    ...
    \label{fig:w03-high-degree-polynomials}
\end{figure}
...
\begin{figure}[H]
    ...
    \label{fig:w03-numerical-instability}
\end{figure}
...
\begin{figure}[H]
    ...
    \label{fig:w03-bias-variance-trade-off}
\end{figure}
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item equivalent to an eigen value condition
    \end{itemize}
...
\begin{itemize}
    ...
    $$\mathcal{L}_{ridge}(\theta;\lambda) = \textcolor{blue}{\underbrace{\frac{1}{n} \sum^n_i (y_i - x_i \beta)^2}_{\text{squared loss}}} + \lambda  \textcolor{red}{\underbrace{\beta^T \beta}_{\text{sq sum coefs}}}$$
...
\begin{figure}[H]
    ...
    \label{fig:w03-right-4-all-l2-regularisation}
\end{figure}
