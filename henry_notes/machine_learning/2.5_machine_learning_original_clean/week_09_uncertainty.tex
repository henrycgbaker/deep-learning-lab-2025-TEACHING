...
\vspace*{0.3cm}
\begin{center}
	{\Large \bfseries ML Lecture Notes: Wk 9 --- Uncertainty}
	\vspace{2mm}
...
\begin{figure}[H]
    ...
    \label{fig:w03-high-degree-polynomials0}
\end{figure}
...
\begin{figure}
    ...
    \caption{Enter Caption}
    \label{fig:w03-high-degree-polynomials1}
\end{figure}
...
\begin{figure}[H]
    ...
    \label{fig:w03-high-degree-polynomials2}
\end{figure}
...
\begin{figure}[H]
    ...
    \label{fig:w03-high-degree-polynomials3}
\end{figure}
% Note: Two GP regressions with different hyperparameters for the kernel, and how these affect the GP's mean predictions and confidence intervals.
\begin{itemize}
