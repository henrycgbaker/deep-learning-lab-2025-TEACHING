...
\vspace*{0.3cm}
\begin{center}
	{\Large \bfseries ML Lecture Notes: Wk 10 --- Neural Nets}
	\vspace{2mm}
...
\begin{figure}[H]
    ...
    \label{fig:w03-high-degree-polynomials4}
\end{figure}
...
\begin{tcolorbox}
    ...
    \begin{figure}[H]
        ...
        \label{fig:w03-high-degree-polynomials5}
    \end{figure}
\end{tcolorbox}
...
\begin{figure}[H]
    ...
    \label{fig:w03-high-degree-polynomials6}
\end{figure}
...
If $\theta_1$ is a $d \times n_1$ matrix; $\theta_2$ is an $n_2 \times n_1$ matrix; and so on.
...
\begin{figure}[H]
    ...
    \caption{Enter Caption}
    \label{fig:w03-high-degree-polynomials7}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Enter Caption}
    \label{fig:w03-high-degree-polynomials8}
\end{figure}
...
\begin{tcolorbox}
    ...
    \begin{figure}[H]
        ...
        \label{fig:w03-high-degree-polynomials9}
    \end{figure}
    ...
    \frac{\partial \mathbf{o}}{\partial \mathbf{x}_1} &= \\
        \textit{how fns change wrt change in input: } &= \frac{\partial \mathbf{o}}{\partial \mathbf{x}_4} \frac{\partial \mathbf{x}_4}{\partial \mathbf{x}_3} \frac{\partial \mathbf{x}_3}{\partial \mathbf{x}_2} \frac{\partial \mathbf{x}_2}{\partial \mathbf{x}_1}\\
      \textit{part derives of features wrt its input: }  &= \frac{\partial f_4(x_4)}{\partial \mathbf{x}_4} \frac{\partial f_3(\mathbf{x}_3)}{\partial \mathbf{x}_3} \frac{\partial f_2(\mathbf{x}_2)}{\partial \mathbf{x}_2} \frac{\partial f_1(\mathbf{x})}{\partial \mathbf{x}} \\
      \textit{as Jacobians: }  &= J_{f_4}(x_4) \cdot J_{f_3}(x_3) \cdot J_{f_2}(x_2) \cdot J_{f_1}(x)
    \end{align*}    
...
\begin{figure}[H]
    ...
    \caption{Enter Caption}
    \label{fig:w03-numerical-instability0}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Enter Caption}
    \label{fig:w03-numerical-instability1}
\end{figure}
...
\begin{itemize}
\item \textbf{Addition Rule:} If \( f(x) \) and \( g(x) \) are functions, then the gradient of their sum with respect to \( x \) is the sum of their individual gradients:
\[ \nabla_x (f(x) + g(x)) = \nabla_x f(x) + \nabla_x g(x) \]

\item \textbf{Multiplication Rule:} The gradient of the product of two functions \( f(x) \) and \( g(x) \) with respect to \( x \) involves the product rule:
\[ \nabla_x (f(x) \cdot g(x)) = f(x) \cdot \nabla_x g(x) + g(x) \cdot \nabla_x f(x) \]

\item \textbf{Composition Rule:} For a composite function \( h(x) = f(g(x)) \), the chain rule gives the gradient of \( h(x) \) with respect to \( x \) as the product of the gradient of \( f(u) \) with respect to \( u \) and the gradient of \( g(x) \) with respect to \( x \):
...
\end{itemize}
 ...
 \begin{figure}[H]
     ...
     \caption{Enter Caption}
     \label{fig:w03-numerical-instability2}
 \end{figure}
...
Together, these three components of the Adam algorithm adapt the learning rate based on the first and second moments of the gradients. This property makes Adam particularly suitable for problems with sparse gradients and/or noisy data, and it is one of the reasons for Adam's popularity in training deep neural networks.
    ...
    \begin{itemize}        \item Adam = SGD, but with momentum
...
functions learnt using ReLUs; we can carve up the areas of the space}
     \label{fig:w03-numerical-instability3}
 \end{figure}
...
\begin{figure}
    ...
    \caption{Enter Caption}
    \label{fig:w03-numerical-instability4}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Enter Caption}
    \label{fig:w03-numerical-instability5}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Enter Caption}
    \label{fig:w03-numerical-instability6}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Drop Out}
    \label{fig:w03-numerical-instability7}
\end{figure}
