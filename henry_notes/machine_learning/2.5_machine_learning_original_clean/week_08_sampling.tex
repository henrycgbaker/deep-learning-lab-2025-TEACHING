...
\vspace*{0.3cm}
\begin{center}
	{\Large \bfseries ML Lecture Notes: Wk 8-II --- Sampling}
	\vspace{2mm}
...
\subsection{Process}
\begin{enumerate}
    \item \textbf{Initial Model Training} -  preliminary model trained on a small set of labeled data: $\{(X_i, y_i)\}_{i=1}^N$.
    \begin{itemize}
...
\begin{figure}[H]
    ...
    \label{fig:w03-regression-vs-classification6}
\end{figure}
...
\begin{figure}[H]
    ...
    \label{fig:w03-regression-vs-classification7}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Enter Caption}
    \label{fig:w03-regression-vs-classification8}
\end{figure}
...
\begin{figure}[H]
    ...
    \label{fig:w03-regression-vs-classification9}
\end{figure}
