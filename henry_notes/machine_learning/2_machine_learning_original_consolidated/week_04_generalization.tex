...
\vspace*{0.3cm} 
\begin{center} 
	{\Large \bf ML Lecture Notes: Wk 4\\ Generalization and Complexity}
	\vspace{2mm}
...
$$R_{\lambda}^{\text{cv}} = \frac{1}{K} \sum_{i=k}^{K} R_i}(\hat{\theta} (D_{-k}^{\text{train}}), D_{k}^{\text{test}})$$
...
$$\textcolor{blue}{p\left( } \textcolor{green}{\max_{f^* \in \mathcal{H}}} \textcolor{red}{\left[ \mathcal{R}(f^*_n) - \mathcal{R}(f^*) \right] \text{is big}} \textcolor{blue}{\right) \text{ is small}}$$
Where
\begin{itemize}
...
\begin{tcolorbox}
    $$
    \textcolor{blue}{p\left(} \textcolor{orange}{\max_{f^* \in \mathcal{H}}} \textcolor{red}{\left[ \mathcal{R}(f^*_n) - \mathcal{R}(f^*) \, \big| \, > \epsilon \right]} \textcolor{blue}{\right)} \leq \textcolor{orange}{2\text{dim}(\mathcal{H})} \, \textcolor{green}{\exp(-2n\epsilon^2)}
    $$
\end{tcolorbox}
Where
\begin{itemize}
...
\begin{tcolorbox}
    $$\textcolor{blue}{p\left(} \textcolor{orange}{\max_{f^* \in \mathcal{H}}} \textcolor{red}{\left[ \mathcal{R}(f^*_n) - \mathcal{R}(f^*)} \textcolor{black}{\leq \sqrt{\frac{1}{n} \left[ \textcolor{orange}{V} \left( \log \frac{2n}{\textcolor{orange}{V}} + 1 \right) - \log \frac{\epsilon}{4}\right]} \right] \approx} \textcolor{green}{1-\epsilon}$$
...
\begin{tcolorbox}
    ...
    $$\textcolor{blue}{p\left( } \textcolor{orange}{\max_{f^* \in \mathcal{H}}} \textcolor{red}{\left[ \mathcal{R}(f^*_n) - \mathcal{R}(f^*) \right]} \text{is big} \textcolor{blue}{\right) \text{ is small}}$$
\end{tcolorbox}
...
For linear classifers: this is often 1 + # of parameters:
...
\begin{tcolorbox}
    Recap:  $X = U\Sigma V^T$ is an $n \timesp$ matrix, of rank $r$
    \begin{itemize}
...
Over paramaterised
\begin{I}
    v High dimensional feature space:
    \begin{itemize}
...
^^^ this was ChatGPT, Drew's slides:
\begin{itemize}
