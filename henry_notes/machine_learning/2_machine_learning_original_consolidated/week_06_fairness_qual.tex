...
\vspace*{0.3cm} 
\begin{center} 
	{\Large \bf ML Lecture Notes: Wk 6 - II \\ Qualitative Fairness}
	\vspace{2mm}
...
Sometimes you might not want to include data you considerd bias / isn't relevant to the purpose of the model.
...
E.gg predicting crime from faces - is there any legitimate reason to be doing so?\\
...
\begin{itemize}
    ...
    \begin{itemize}
        \item if you don't measure across features, you can;t see that there's differentce between them
