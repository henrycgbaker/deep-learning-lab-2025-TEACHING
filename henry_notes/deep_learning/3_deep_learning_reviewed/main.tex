...
% Weekly content
\input{week_1_intro_dl}
\input{week_2_dnn_fundamentals}
\input{week_3_dnn_training}
\input{week_4_cnn_fundamentals}
\input{week_5_cnn_applications}
\input{week_6_rnn_lstm}
\input{week_7_nlp_embeddings}
\input{week_8_attention_transformers}
\input{week_9_llms_practice}
