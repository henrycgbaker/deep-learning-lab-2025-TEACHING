...
\begin{align*}
    ...
    &= g \left( b_{\textcolor{red}{i}}^{[1]} + \sum^d_{\textcolor{green}{j}} w_{\textcolor{red}{i}\textcolor{green}{j}}^{[1]} x_{\textcolor{green}{j}} \right)
\end{align*}
...
\begin{align*}
    ...
    \textit{*}&= w_{ij}^{(r)} - \eta \left(-2(y-f(x))w_i^{[2]}\sigma (a^{[1]})(1-\sigma(a)^{[1]})x_j\right)^{(r)}
\end{align*}
